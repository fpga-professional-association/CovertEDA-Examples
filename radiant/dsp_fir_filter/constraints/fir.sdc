...
set_input_delay -clock clk_sys -max 3.0 [get_ports {valid_in rst_n}]
set_input_delay -clock clk_sys -min 1.0 [get_ports {valid_in rst_n}]

# Output delays (DSP blocks pipelined)
set_output_delay -clock clk_sys -max 4.0 [get_ports {data_out[*]}]
set_output_delay -clock clk_sys -min 2.0 [get_ports {data_out[*]}]
set_output_delay -clock clk_sys -max 4.0 [get_ports valid_out]
set_output_delay -clock clk_sys -min 2.0 [get_ports valid_out]
